            ...
            <div class="portlet light portlet-fit bordered calendar">
                <div class="portlet-title">
                    ...
                    <div class="caption pull-right">
                        <a class="btn btn-outline-success m-btn m-btn--custom" href="{{ route('admin.IndustriesAdvertsCompanies.create') }}">Create</a>
                    </div>
                </div>
                                            ...
                                            @foreach($articles as $article)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ route('admin.IndustriesAdvertsCompanies.edit', ['id' => $article->id]) }}" class="btn btn-outline-info m-btn m-btn--icon m-btn--icon-only m-btn--custom m-btn--pill m-btn--air">
                                                            <i class="la la-edit"></i>
                                                        </a>
                                                        <form method="post" action="{{ route('admin.IndustriesAdvertsCompanies.destroy', ['id' => $article->id]) }}" class="userDeleteForm">
