...
<div class="m-portlet">
	...
	<!--begin::Form-->
	<form class="m-form" method="post" action="{{ route('admin.advertiserCompanies.store') }}" enctype="multipart/form-data">
		{{csrf_field()}}
		...
		<div class="m-portlet__body">
				...
				<div class="form-group m-form__group row">
					...
					<div class="col-md-4">
						<div class="input-group">
							<input type="text" class="form-control" id="geocomplete" placeholder="Search for...">
							<div class="input-group-append">
								<button id="find" class="btn btn-success" type="button">
									Go!
								</button>
							</div>
						</div>
				...
				<div class="form-group m-form__group row">
					...
					<div class="col-lg-6">
						<select class="form-control select2" name="industries[]" id="m_select2_3" multiple>
