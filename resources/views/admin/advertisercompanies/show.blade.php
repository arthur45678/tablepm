...
@section('scripts')
    ...
    <script src="{{ $assetPath }}/global/plugins/jquery_geocomplete/jquery.geocomplete.js"></script>
    ...
    <script>
        $(document).ready(function()
        {
            ...
            /*Map */
            //Location
                    @if(isset($article->lat) && isset($article->lng))

            var center = new google.maps.LatLng({{ $article->lat }}, {{ $article->lng }}),
