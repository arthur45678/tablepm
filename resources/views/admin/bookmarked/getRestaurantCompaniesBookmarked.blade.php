                                            ...
                                            @foreach($articles as $article)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @if($user->bookmarkedAdvertComp()->where(['rest_comp_id' => $article->id])->first())
                                                            <td><a class="btn btn-outline-info m-btn m-btn--icon m-btn--icon-only m-btn--custom m-btn--pill m-btn--air" href="{{ route('admin.bookmarked.deleteAdvertiserCompaniesBookmarked', ['id' => $article->id]) }}"><i class="fa fa-bookmark" data-toggle="tooltip" data-placement="left" title=""></i></a></td>
