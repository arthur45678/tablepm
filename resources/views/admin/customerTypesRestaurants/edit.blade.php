...
<div class="m-portlet">
	...
	<!--begin::Form-->
	<form class="m-form" method="post" action="{{ route('admin.customerTypesRestaurants.update', ['id' => $article->id]) }}">
			...
			<div class="m-form__actions m-form__actions">
				<div class="row">
					...
					<div class="col-lg-6">
						...
						<a class="btn btn-secondary" href="{{ route('admin.customerTypesRestaurants.index') }}">Cancel</a>
					</div>
				</div>
			</div>
		</div>
