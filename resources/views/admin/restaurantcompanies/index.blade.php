            ...
            <div class="portlet light portlet-fit bordered calendar">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green sbold uppercase page-title">{{ isset($title) ? $title : 'Admin panel' }}</span>
                    </div>

                    <div class="caption pull-right">
                        <a class="btn btn-outline-success m-btn m-btn--custom" href="{{ route('admin.RestaurantCompanies.create') }}">Create</a>
                    </div>
                </div>
                                            ...
                                            @foreach($articles as $article)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ route('admin.RestaurantCompanies.edit', ['id' => $article->id]) }}" class="btn btn-outline-info m-btn m-btn--icon m-btn--icon-only m-btn--custom m-btn--pill m-btn--air">
                                                            <i class="la la-edit"></i>
                                                        </a>
                                                        <form method="post" action="{{ route('admin.RestaurantCompanies.destroy', ['id' => $article->id]) }}" class="userDeleteForm">
                                                           ...
                                                           <!--  <a  data-toggle="modal" data-target="#{{ $user->id }}" class="deleteAnchor btn btn-danger" href=""><i class="fa fa-trash" data-toggle="tooltip" data-placement="left" title="Delete"></i></a> -->
                                                            ...
                                                            <a href="{{ route('admin.restaurantShopProfile.getRestaurantShopsByRestaurantID', ['id' => $article->id]) }}">Shops</a>
    ...
    <script>
        $(document).ready(function()
        {
            ...
            $('#search').on('keyup', function () {
                ...
                $.ajax({
                    type: 'GET',
                    url: '{{ route('admin.RestaurantCompanies.search') }}',
                    data: { 'search': value },
