            ...
            <div class="portlet light portlet-fit bordered calendar">
                <div class="portlet-title">
                    ...
                    <div class="caption pull-right">
                        <a class="btn btn-primary" href="{{ route('admin.RestaurantCompanies.create') }}">Create</a>
                    </div>
                </div>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="deleteAnchor btn btn-primary" href="{{ route('admin.RestaurantCompanies.edit', ['id' => $article->id]) }}"><i class="fas fa-edit" data-toggle="tooltip" data-placement="left" title="Edit"></i></a></td>
                                        <td>

                                            <form method="post" action="{{ route('admin.RestaurantCompanies.destroy', ['id' => $article->id]) }}">
