                ...
                <div class="portlet-body">
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <form id="updateForm" class="form-horizontal"  method="post" action="{{ route('admin.restaurantcuisine.update', ['id' => $article->id]) }}" enctype="multipart/form-data">
                                        ...
                                        @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                            <div role="{{$localeCode}}" class="tab-pane {{ (App::getLocale() ==  $localeCode) ? 'active' : ''}}" id="tab_{{$localeCode}}">
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label col-md-3" for="title_{{$localeCode}}">Compamy Name</label>
                                                    <div class="col-md-4">
