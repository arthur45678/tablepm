...
<div class="m-portlet">
	...
	<!--begin::Form-->
	<form class="m-form" method="post" action="{{ route('admin.restaurantcuisine.update', ['id' => $article->id]) }}">
			...
			<div class="m-form__actions m-form__actions">
				<div class="row">
					...
					<div class="col-lg-6">
						...
						<a href="{{ route('admin.restaurantcuisine.index') }}" class="btn btn-secondary">Cancel</a>
					</div>
				</div>
			</div>
		</div>
