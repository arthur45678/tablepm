            ...
            <div class="portlet light portlet-fit bordered calendar">
                <div class="portlet-title">
                    ...
                    <div class="caption pull-right">
                        <a class="btn btn-primary" href="{{ route('admin.dish.create') }}">Create</a>
                        <br><br>
                    </div>
                </div>
                                ...
                                @foreach($articles as $article)
                                    <tr>
                                        ...
                                        @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                            ...
                                            @endif
                                        @endforeach
                                        <td><a class="btn btn-primary" href="{{ route('admin.dish.show', ['id' => $article->id]) }}"><i class="fa fa-file" data-toggle="tooltip" data-placement="left" title="Edit"></i></a></td>
                                        <td><a class="deleteAnchor btn btn-primary" href="{{ route('admin.dish.edit', ['id' => $article->id]) }}"><i class="fas fa-edit" data-toggle="tooltip" data-placement="left" title="Edit"></i></a></td>
                                        <td>

                                            <form method="post" action="{{ route('admin.dish.destroy', ['id' => $article->id]) }}">
