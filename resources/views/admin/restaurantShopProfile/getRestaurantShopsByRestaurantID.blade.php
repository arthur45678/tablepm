            ...
            <div class="portlet light portlet-fit bordered calendar">
                <div class="portlet-title">
                    ...
                    <div class="caption pull-right">
                        <a class="btn btn-outline-success m-btn m-btn--custom" href="{{ route('admin.restaurantShopProfile.create', ['slug' => $restaurant->slug]) }}">Create</a>
                    </div>
                </div>
                                        ...
                                        @foreach($articles as $article)
                                            <tr>
                                                ...
                                                <!-- <a href="{{ route('admin.users.show', ['id' => $user->id]) }}" class="btn btn-outline-info m-btn m-btn--icon m-btn--icon-only m-btn--custom m-btn--pill m-btn--air">
                                                    ...
                                                    <a href="{{ route('admin.restaurantShopProfile.edit', ['id' => $article->id]) }}" class="btn btn-outline-info m-btn m-btn--icon m-btn--icon-only m-btn--custom m-btn--pill m-btn--air">
                                                        <i class="la la-edit"></i>
                                                    </a>
                                                    <form method="post" action="{{ route('admin.restaurantShopProfile.destroy', ['id' => $article->id]) }}" class="userDeleteForm">
