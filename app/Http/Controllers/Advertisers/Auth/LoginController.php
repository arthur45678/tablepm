...
class LoginController extends Controller
{
    ...
    */
    ...
    protected function authenticated()
    {
        ...
        return redirect('/advertiser/index');
    }
    ...
    public function login(AdvertiserLoginRequest $request)
    {
        if(Auth::attempt(['email' => $request->email, 'password' => $request->password])) {
            $user = Auth::user();
            if($user->confirmed == 0 || $user->is_active == 0) {
                Auth::logout();
            ...
            return redirect()->back()->with('message_login','These credentials do not match our records.');
        }
    }
